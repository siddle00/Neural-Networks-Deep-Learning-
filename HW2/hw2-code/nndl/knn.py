...
class KNN(object):
    ...
    def compute_L2_distances_vectorized(self, X):
        ...
        dists = np.sqrt(x_test_square + x_train_square - 2*dot_test_train)
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in np.arange(num_test):
          ...
          # ================================================================ #
            ...
            class_closest_y = self.y_train[closest_y].tolist()       
            
            y_pred[i] = max(set(class_closest_y),key=class_closest_y.count)
